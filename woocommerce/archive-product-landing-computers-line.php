...
<div class="bm-landing-category-computers-section-1-line-banner">
	<div class="bm-adaptive bm-margin bm line-banner">
		<div class="bm-landing-category-computers-section-1-line-banner-container decstop">
			<div class="bm-landing-category-computers-section-1-line-banner-container-first animate__animated animate__fadeIn animate__delay-1s animate__slow" data-wow-delay="0.9s" data-wow-duration="1.5s">
				<img src="/wp-content/uploads/li-new.webp">
			</div>
			<div class="bm-landing-category-computers-section-1-line-banner-container-second animate__animated animate__fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.9s">
				<img src="/wp-content/uploads/line-new.webp">
			</div>
			<div class="bm-landing-category-computers-section-1-line-banner-container-third animate__animated animate__fadeIn animate__slow" data-wow-delay="1.2s" data-wow-duration="1.5s">
				<img src="/wp-content/uploads/ne-new.webp">
			</div>			
		</div>
		<div class="bm-landing-category-computers-section-1-line-banner-container mobile">
			<img src="/wp-content/uploads/line-2.webp" class="line animate__animated animate__fadeIn animate__delay-1s animate__slow">
			<img src="/wp-content/uploads/line-new.webp" class="line-computer animate__animated animate__fadeInUp">
		</div>
	</div>
</div>
<style>
	@media screen and (min-width: 768px) and (max-width: 992px){
		.bm-landing-category-computers-section-1-line-banner-container.mobile .line{
			max-width: 60%;
		}	
	...
	@media screen and (min-width: 992px) and (max-width: 1200px){
		...
		.bm-landing-category-computers-section-1-line-banner-container.mobile .line-computer{
			max-height: 500px !important;
		}
	}	
	@media screen and (min-width: 1200px) and (max-width: 1600px){
		.bm-landing-category-computers-section-1-line-banner-container-first{
			flex-basis: 24%;
		}
		.bm-landing-category-computers-section-1-line-banner-container-second{
			flex-basis: 32%;
		}
		.bm-landing-category-computers-section-1-line-banner-container-third{
			flex-basis: 32%;
		}
	}
	@media screen and (max-width: 1200px){
		...
		.bm-landing-category-computers-section-2-svet{
			background: none !important;
		}
		.bm-landing-category-computers-section-1-line-banner{
			height: auto !important;
			padding: 30px 0;
		}
		.bm-landing-category-computers-section-1-line-banner-container.decstop{
			display: none;
		}
		.bm-landing-category-computers-section-1-line-banner-container.mobile{
	...
	.bm-landing-category-computers-section-2-svet{
		background: url(/wp-content/uploads/bm-line-svet-2.webp);
		background-position: center;
		background-size: contain;
    	background-repeat: no-repeat;
		background-position-y: 100px;
	}
	.bm-landing-category-computers-section-1-line-banner-container-second{--animate-duration: 1.4s;}
	.bm-landing-category-computers-section-1-line-banner-container-third{--animate-delay: 1.5s; animation-delay: 1.7s;}
	.line-banner{
		height: 100%;
	}
	.bm-landing-category-computers-section-1-line-banner-container{
		display: flex;
	...
	.bm-landing-category-computers-section-1-line-banner-container-second img{
		max-height: 75vh;
	}
	.bm-landing-category-computers-section-1-line-banner{
		height: 100vh;
		background: url(/wp-content/uploads/background-banner-2-line.webp);
		background-position: center;
...
<div class="bm-landing-category-computers-section-2" id="about">
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-computers-section-2-svet">
	...
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-computers-section-videocard-container">
			...
			<p class="bm-landing-category-computers-section-videocard-container__text wow animate__animated animate__fadeInUp">
				Видеокарта GeForce RTX™ 3080 работает на базе Ampere — архитектуры NVIDIA RTX второго поколения, чем обеспечивает рекордную производительность для геймеров. Она оснащена улучшенными ядрами RT и тензорными ядрами, новыми потоковыми мультипроцессорами и высокоскоростной памятью G6X для потрясающих игровых возможностей. 
			</p>
	...
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-computer-landing-section11">
			<div class="bm-computer-landing-section3-content">
				<h1 class="bm-computer-landing-section11-content__title">Купи новый ПК <?php woocommerce_page_title(); ?></h1>					
			</div>	
