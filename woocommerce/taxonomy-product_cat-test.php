<?php get_header(); ?>
        ...
        <div class="bm-adaptive bm-margin bm">
            <div class="arenda-kresla-main">
                ...
                <p class="arenda-kresla-text__text">
                    Наши специалисты доставят нужные модели прямо к вам домой в Москве или Подмосковье, чтобы вы смогли протестировать их в реальных игровых и рабочих условиях и определиться с выбором. Попробуйте комфорт иного уровня!                </p>
                <p class="arenda-price">от 9 990 р</p>
                <a uk-toggle href="#modal-center" class="arenda-kresla-text__form uncor">Оформить тест кресла на дому</a>

                <img src="/wp-content/uploads/test-kresla.webp">
            </div>
            <div class="arenda-kresla">
                <div class="arenda-kresla-text">
                    ...
                    <img src="/wp-content/uploads/arenda-kresel.webp" class="d-mob-block mobile-img-w">
                    <p class="arenda-stoim-text">
                        Услуга тест-драйва подразумевает доставку по Москве или МО и сборку двух или более игровых кресел. Окончательная стоимость тест-драйва согласуется менеджером на стадии оформления заказа.
                    </p>
                    <p class="arenda-stoim-text danger">
                        При покупке одного из привезенных кресел услуга теста кресла на дому засчитывается в счет стоимости кресла.                    </p>
                    <a uk-toggle href="#modal-center" class="arenda-kresla-text__stoimost uncor">Оформить тест кресла на дому</a>
                </div>
                <div class="arenda-kresla-img pad d-mob">
                    <img src="/wp-content/uploads/arenda-kresel.webp">
                </div>
            </div>
            <div class="arenda-kresla-steps">
                <h2 class="arenda-kresla-steps__title">
                    4 простых шага протестировать кресло дома
                </h2>
                <div class="stepper-wrapper">
                    ...
                    <div class="stepper-item">
                        ...
                        <div class="step-name">Дождитесь звонка<br>нашего менеджера</div>
                    </div>
                    <div class="stepper-item">
                        <div class="step-counter">4</div>
                        <div class="step-name">Наслаждайтесь<br>комфортом</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bm-adaptive bm-margin bm">
                <div class="arenda-form">
                    <h2 class="arenda-kresla-text__title center">
                        Заполните заявку на тест кресла дома
                    </h2>
    ...
    <style>
        ...
        .arenda-stoim-text.danger::before{
            content: url("/wp-content/uploads/danger.svg");
            margin-right: 20px;
        }
        .arenda-stoim-text.danger{
            display: flex;
            align-items: center;
        }
        ...
        @media screen and (min-width: 992px) and (max-width: 1200px){
            ...
            .arenda-kresla-text__title, .arenda-kresla-steps__title{font-size: 36px !important; text-align: center;}
            .d-mob-block{display: block !important; margin: 20px 0 20px 0;}
            .pad{padding-right: 0 !important;}
            .arenda-kresla{grid-template-columns: 100% !important;}
            .mobile-img-w{max-width: 60%; margin: 40px auto 40px auto !important;}
        }
        ...
        @media screen and (max-width: 768px){
            h1,h2{margin-bottom: 25px !important;}
            .arenda-form-container{padding: 70px 0 !important;}
            .arenda-kresla-forrm{max-width: 100% !important;}
            ...
            .arenda-kresla-text{margin-top: 0 !important;}
            .arenda-kresla-text__title, .arenda-kresla-steps__title{font-size: 28px !important; text-align: center;}
            .d-mob-block{display: block !important; margin: 40px 0 40px 0;}
            .pad{padding-right: 0 !important;}
            .arenda-kresla{grid-template-columns: 100% !important}
        }
        ...
        */
        ...
        .arenda-kresla-text{flex-basis: 50%;}
