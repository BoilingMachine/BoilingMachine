...
<div class="bm-landing-category-tmachine-banner">
	<video class="grpzdc-banner-video"  loop muted autoplay playsinline>
		<source src="/wp-content/uploads/dosia-glitch.mp4">
		<source src="/wp-content/uploads/dosia-glitch.webm" type="video/webm">
	</video> 
</div>
<style>
	...
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-collabs-boilingfeat-container">
			...
			<div class="bm-landing-category-collabs-boilingfeat-container-first">
				<video class="grpzdc-banner-video"  loop muted autoplay playsinline>
					<source src="/wp-content/uploads/c4.mp4">
					<source src="/wp-content/uploads/c4.webm" type="video/webm">
				</video> 
			</div>	
		</div>
	</div>
...
<style>
	...
	.bm-landing-category-collabs-boilingfeat-container-second__title::before{
		content: url(/wp-content/uploads/dosia-bf-first-section.svg);
		position: absolute;
		z-index: -1;
		left: -25%;
		bottom: -50%;		
	}
	.bm-landing-category-collabs-section-2-container-first__title::before{
		content: url(/wp-content/uploads/dosia-bf-second-section.svg);
		position: absolute;
		z-index: -1;
		left: 40%;
		bottom: -110%;		
	...
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-collab-fishki-container">
			...
			<p class="bm-landing-category-collab-podpiska-container__subtitle">
				При покупке Boiling XGOD Machine вы можете выбрать один из четырех подарков 
			</p>			
			<div class="bm-landing-category-collab-fishki-container-blocks">
				<div class="bm-landing-category-collab-fishki-container-blocks-block">
					<img src="/wp-content/uploads/dosia-benefit-1.svg">
					<h3 class="bm-landing-category-collab-fishki-container-blocks-block__title">
						Игра 1 на 1 или Ranked-матч
					</h3>
					<p class="bm-landing-category-collab-fishki-container-blocks-block__text">
						Покупатели Boiling XGod Machine гарантированно сыграют матч вместе с Dosia
					</p>
				</div>
				<div class="bm-landing-category-collab-fishki-container-blocks-block">
					<img src="/wp-content/uploads/dosia-benefit-2.svg">
					<h3 class="bm-landing-category-collab-fishki-container-blocks-block__title">
						Участие в розыгрыше
					</h3>
					<p class="bm-landing-category-collab-fishki-container-blocks-block__text">
						При покупке ПК вы автоматически становитесь участником розыгрыша уникального скина на АК-47, Desert Eagle, AWP или нож
					</p>
				</div>
				<div class="bm-landing-category-collab-fishki-container-blocks-block">
					<img src="/wp-content/uploads/dosia-benefit-3.svg">
					<h3 class="bm-landing-category-collab-fishki-container-blocks-block__title">
						Мерч
					</h3>
					<p class="bm-landing-category-collab-fishki-container-blocks-block__text">
						При покупке Boiling XGod Machine вы получите памятный мерч от Dosia
					</p>
				</div>
				<div class="bm-landing-category-collab-fishki-container-blocks-block">
					<img src="/wp-content/uploads/dosia-benefit-4.svg">
					<h3 class="bm-landing-category-collab-fishki-container-blocks-block__title">
						Автограф
					</h3>
					<p class="bm-landing-category-collab-fishki-container-blocks-block__text">
						Dosia оставит свой автограф прямо на коробке
					</p>
				</div>				
			</div>
		</div>
...
<div class="bm-landing-category-collab-podpiska" id="service">
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-collab-podpiska-container">
			...
			<p class="bm-landing-category-collab-podpiska-container__subtitle">
				По специальному промокоду от Dosia вы получите сервисную поддержу уровня Premium 
			</p>
			<div class="bm-landing-category-collab-podpiska-container-blocks">
				<div class="bm-landing-category-collab-podpiska-container-blocks-block">
					...
					<ul class="bm-landing-category-collab-podpiska-container-blocks-block__spisok">
						...
						<li><p>Консультация по телефону и почте</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Видео консультация удобным для вас способом</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						...
						<li><p>Полная диагностика ПК</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Чистка компонентов</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Проверка и обновление драйверов</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Замена термоинтерфейсов</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Настройка системы теплоотвода</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
					</ul>						
				</div>
				<div class="bm-landing-category-collab-podpiska-container-blocks-block grad">
					...
					<ul class="bm-landing-category-collab-podpiska-container-blocks-block__spisok">
						...
						<li><p>Консультация по телефону и почте</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Видео консультация удобным для вас способом</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Приоритетное рассмотрение заявки</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Выделенный специалист</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Полная диагностика ПК</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Чистка компонентов</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Проверка и обновление драйверов</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
						<li><p>Замена термоинтерфейсов</p><img src="/wp-content/uploads/dosia-arrow.svg"></li>
...
<style>
	...
	.bm-landing-category-collab-fishki-container__title::before{
		position: absolute;
		z-index: -1;
		content: url(/wp-content/uploads/benefits-back.webp);	
		left: 50%;
		top: -130%;		
	}
	.bm-landing-category-collab-fishki-container-blocks{
...
<style>
	...
	.bm-landing-category-computers-section-4-container-grafic-header-videortx3080{
		background: linear-gradient(0deg, #DF1931, #DF1931);
	}
