...
<div class="bm-landing-category-tmachine-banner">
	<video class="grpzdc-banner-video"  loop muted autoplay playsinline>
		<source src="/wp-content/uploads/kritos-banner-new.mp4">
	</video> 
	
	<!--<img src="/wp-content/uploads/kritos-banner.webp">-->
</div>
<style>
...
<div class="bm-landing-category-collabs-boilingfeat" id="about">
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-collabs-boilingfeat-container">
			<img src="/wp-content/uploads/2-kritos-block-1.webp" class="bm-landing-category-collabs-boilingfeat-container-kritos">
			<div class="bm-landing-category-collabs-boilingfeat-container-kritos-text">
				<h2 class="bm-landing-category-collabs-boilingfeat-container-kritos-text__title">
					ПК как у блогера 
				</h2>
				<p class="bm-landing-category-collabs-boilingfeat-container-kritos-text__text">
...
<style>
	...
	.bm-landing-category-collabs-boilingfeat-container{
		display: flex;
		flex-direction: column;
		background: url(/wp-content/uploads/2-kritos-block-svet.webp);
		padding-bottom: 200px;
		position: relative;
	}
	.bm-landing-category-collabs-boilingfeat-container-kritos-text{
		position: absolute;
		bottom: 0;
	}
	.bm-landing-category-collabs-boilingfeat-container-kritos-text__title{
		font-style: normal;
		font-weight: bold;
		font-size: 80px;
		line-height: 110%;
	...
	.bm-landing-category-collabs-boilingfeat-container-kritos-text__text{
		font-style: normal;
		font-weight: normal;
		font-size: 22px;
		line-height: 150%;
	...
	.bm-landing-category-collabs-boilingfeat{
		background: url(/wp-content/uploads/kritos-back.webp);		
	...
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-collab-fishki-container">
			...
			<p class="bm-landing-category-collab-podpiska-container__subtitle">
				При покупке Boiling KRITOS Machine вы можете выбрать один из четырех подарков 
			</p>			
			<div class="bm-landing-category-collab-fishki-container-blocks">
				<div class="bm-landing-category-collab-fishki-container-blocks-block">
					<img src="/wp-content/uploads/kritos1.png">
					<h3 class="bm-landing-category-collab-fishki-container-blocks-block__title">
						Участие в видео с KRITOS
					</h3>
					<p class="bm-landing-category-collab-fishki-container-blocks-block__text">
						 Каждый покупатель гарантированно попадут в видео на YouTube-канал Boiling Machine
					</p>
				</div>
				<div class="bm-landing-category-collab-fishki-container-blocks-block">
					<img src="/wp-content/uploads/kritos2.png">
					<h3 class="bm-landing-category-collab-fishki-container-blocks-block__title">
						 Доставка ПК лично KRITOS 
					</h3>
					<p class="bm-landing-category-collab-fishki-container-blocks-block__text">
						Для первых пяти покупателей Илья KRITOS гарантированно осуществит доставку ПК прямо до вашей двери
					</p>
				</div>
				<div class="bm-landing-category-collab-fishki-container-blocks-block">
					<img src="/wp-content/uploads/kritos3.png">
					<h3 class="bm-landing-category-collab-fishki-container-blocks-block__title">
						Шанс сборки ПК с Критосом
					</h3>
					<p class="bm-landing-category-collab-fishki-container-blocks-block__text">
						При покупке Boiling KRITOS Machine вы вместе с Ильей можете поучаствовать в процессе сборки вашего ПК
					</p>
				</div>
				<div class="bm-landing-category-collab-fishki-container-blocks-block">
					<img src="/wp-content/uploads/kritos4.png">
					<h3 class="bm-landing-category-collab-fishki-container-blocks-block__title">
						Автограф
					</h3>
					<p class="bm-landing-category-collab-fishki-container-blocks-block__text">
						KRITOS оставит автограф на коробке или корпусе вашего ПК
					</p>
				</div>				
			</div>
		</div>
...
<div class="bm-landing-category-collab-podpiska" id="service">
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-collab-podpiska-container">
			...
			<p class="bm-landing-category-collab-podpiska-container__subtitle">
				По специальному промокоду от KRITOS вы получите сервисную поддержу уровня Premium 
			</p>
			<div class="bm-landing-category-collab-podpiska-container-blocks">
				<div class="bm-landing-category-collab-podpiska-container-blocks-block">
					...
					<ul class="bm-landing-category-collab-podpiska-container-blocks-block__spisok">
						...
						<li><p>Консультация по телефону и почте</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Видео консультация удобным для вас способом</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						...
						<li><p>Полная диагностика ПК</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Чистка компонентов</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Проверка и обновление драйверов</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Замена термоинтерфейсов</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Настройка системы теплоотвода</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
					</ul>						
				</div>
				<div class="bm-landing-category-collab-podpiska-container-blocks-block grad">
					...
					<ul class="bm-landing-category-collab-podpiska-container-blocks-block__spisok">
						...
						<li><p>Консультация по телефону и почте</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Видео консультация удобным для вас способом</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Приоритетное рассмотрение заявки</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Выделенный специалист</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Полная диагностика ПК</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Чистка компонентов</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Проверка и обновление драйверов</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
						<li><p>Замена термоинтерфейсов</p><img src="/wp-content/uploads/kritos-angle.svg"></li>
...
<style>
	...
	.bm-landing-category-tmachine-banner{
		text-align: center;
		background: #000;
	}
...
<style>
	...
	.bm-landing-category-computers-section-4-container-grafic-header-videortx3080{
		background: linear-gradient(0deg, #F92E24, #F92E24);
	}
	...
	@media screen and (min-width: 576px) and (max-width: 768px){
		...
		.bm-landing-category-collabs-boilingfeat-container-kritos-text__title, .bm-landing-category-collabs-section-2-container-first__title, .bm-landing-category-collab-fishki-container__title, .bm-landing-category-collab-podpiska-container__title, .bm-landing-category-computers-section-3-container__title, .bm-landing-category-computers-section-videocard-container__title, .bm-landing-category-computers-section-5-container__title, .bm-landing-category-computers-section-7-container__title, .bm-landing-category-computers-section-4-container__title, .bm-landing-category-computers-section-10-container__title, .bm-computer-landing-section11-content__title {
			font-size: 36px !important;
		}		
	}
	@media screen and (min-width:768px) and (max-width: 1200px){
