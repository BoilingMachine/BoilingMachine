				...
				<div class="bm-computer-landing-header-menu">
					<nav class="navbar navbar-expand-lg header-nav bm-computer-landing-header-menu__nav">			  
					  <div class="collapse navbar-collapse" id="navbarSupportedContent">
					    <ul class="navbar-nav">
					      <li class="nav-item">
					        <a class="nav-link header-link uncor" href="#cachestvo">Качество</a>
					      </li>
					      <li class="nav-item">
					        <a class="nav-link header-link uncor" href="#proizviditelnost">Производительность</a>
					      </li>		
					      <li class="nav-item">
					        <a class="nav-link header-link uncor" href="#dizajn">Дизайн</a>
					      </li>				      				      	      
					    </ul>
					  </div>
					</nav>
