...
<div class="bm-landing-category-computers-section-2" id="about">
	<div class="bm-adaptive bm-margin bm">
		<div class="bm-landing-category-computers-section-2-container">
			<h1 class="bm-landing-category-computers-section-2-container__title wow animate__animated animate__fadeInUp">
...
<style>
	...
	.bm-landing-category-computers-section-3-container-config-box__text, .bm-landing-category-computers-section-7-container__container-block__title, .bm-landing-category-computers-section-8-container-computer-charak-block__text, .bm-landing-category-computers-section-9-container__container-block__title{
		color: #FFA400;
	}
