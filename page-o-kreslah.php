...
<section class='nav-kresla-tabs'>
    <div class="mywoo-computers-tabs">
        <ul class="nav nav-pills">
            <li class="active"><a class="mywoo-nav-link-kresl active" href="/o-kreslah/">Статьи</a></li>
            <li><a href="/o-kreslah/kresla-obzory" class="mywoo-nav-link-kresl ">Обзоры</a></li>
          </ul>
    </div>
</section>
