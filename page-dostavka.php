	...
	<div class="bm-adaptive bm-margin bm">
		...
		<div class="bm-contacts-body">
			<div class="mywoo-computers-tabs">	  
			  <ul class="nav nav-tabs">
				<li class="nav-item"> 
				  <a class="nav-link active mywoo-nav-link" href="/uslugi/dostavka/">Доставка</a>
				</li>
				<li class="nav-item">
				  <a class="nav-link mywoo-nav-link" href="/uslugi/oplata/">Оплата</a>
				</li>	
				<li class="nav-item">
	  ...
	  <div class="tab-content">
		<div id="home" class="tab-pane active"><br>
			<div class="mywoo-computers-list">										
				<?php include 'templates/pay.php'; ?>
			</div>
		</div>			
	  </div>		
